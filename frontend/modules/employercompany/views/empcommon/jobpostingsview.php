...
<div class="box">
	...
	<table id="vertical-1">
		...
		<tr>
			<img src="/jobportal/frontend/web/images/tick1.jpg"><?php echo  $postings->Min_Experience;  ?></tr>
		&nbsp;&nbsp;
		<tr>
			<img src="/jobportal/frontend/web/images/tick1.jpg"><?php echo  $postings->Max_Experience;  ?></tr>
		&nbsp;&nbsp;
		<tr>
			<img src="/jobportal/frontend/web/images/art.png"><?php echo  $postings->state; $postings->city; $postings->country;  ?></tr>
		<br>
		<br>
	...
	<h4>Company Profile: ExpertWebWorx Pvt.Ltd</h4>
	<p>ExpertWebWorx Pvt.Ltd world's best talent for hiring your dedicated
		resources</p>
</div>
<div class="box">
	<tr>
	...
	<tr>
		<td>Website:</td>
		<td><a href="http://www.expertwebworx.com/">http://www.ExpertWebworx,com</a>
		</td>
	</tr>
