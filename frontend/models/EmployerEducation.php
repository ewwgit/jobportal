...
class EmployerEducation extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['higherdegree', 'specialization', 'university', 'collegename', 'passingyear', 'userid'], 'required'],
            [['userid'], 'integer'],
            [['higherdegree', 'specialization', 'university', 'collegename'], 'string', 'max' => 220],
        [['higherdegree', 'specialization', 'university', 'collegename', 'passingyear', 'userid'], 'safe'],
        ];
    }
