...
class JobpostSearch extends EmployerJobpostings
{
    ...
    {
        return [
            [['rolecategory','skills','designation','Min_Experience','Max_Experience','Description','jobtype','gender','address','company_name','company_type','industry_type','dateofestablishment','country','state','city','zipcode'], 'safe'],
      ...
      public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'rolecategory', $this->rolecategory])
            ...
            ->andFilterWhere(['like', 'Min_Experience', $this->Min_Experience])
            ->andFilterWhere(['like', 'Max_Experience', $this->Max_Experience])
