...
<!-- Banner
================================================== -->
<div id="banner" class="with-transparent-header parallax background" style="background-image: url(<?php echo Yii::getAlias('@web');?>/frontend/web/images/banner-02.jpg)" data-img-width="2000"     data-img-height="1330" data-diff="300">
  <div class="container" >
		    ...
		    <?php $form = ActiveForm::begin([
		        ...
		        'fieldConfig' => [
		            ...
		            <?php 
					    ...
					    'data' => $companydata,
					    'options' => ['placeholder' => 'Enter ...','class'=>'mdcls' ],
    		 ...
    		 ?>
		            ...
		            <?php 
		                           ...
		                           echo  $form->field($searchModel, 'skills')->widget(Select2::classname(), [
		                           		       ...
		                           		       'data'=>$skillsInfo,
		                           		        'options' => ['placeholder' => 'Enter Skills...', 'multiple' => true],
		                                        'pluginOptions' => [
		                                        'tags' => true,
		                                        'allowClear' => true,
		                                        'tokenSeparators' => [','],
